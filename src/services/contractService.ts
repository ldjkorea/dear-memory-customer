...
export class ContractService {
  ...
  static async createContractFromRequest(requestId: string): Promise<{
    ...
    const snapshot: ContractSnapshot = {
      ...
      makeup_venue: request.makeup_venue,
      makeup_out_time: request.makeup_out_time,
      groom_family_members: request.groom_family_members,
      bride_family_members: request.bride_family_members,
      mate_discount_info: request.mate_discount_info,
      shooting_requests: request.shooting_requests,
      retouch_requests: request.retouch_requests,
